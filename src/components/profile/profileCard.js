    ...
    return (
      ...
      <div className="relative z-30 mx-auto -mt-20 h-30 w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:w-44 sm:p-2">
        ...
        <div class="mt-4">
          ...
          <div
            class="text-gray-400 mx-auto mt-4 mb-5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2 shadow-5">
            <div
              class="flex items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark xsm:flex-row">
          ...
          <div class="mt-6">
            ...
            <div class="flex items-center justify-center gap-3 text-gray-400">
              <a href="#" class="hover:text-blue-700" name="social-icon" aria-label="social-icon">
