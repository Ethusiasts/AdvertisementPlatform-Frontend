import CoverOne from '../../images/cover-01.png';
...
export default function ProfileCard() {
    return (
      ...
      <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11">
        ...
        <div class="mt-4">
          <h3 class="mb-1 text-2xl font-medium text-black dark:text-white">
            Danish Heilium
          </h3>
          <p class="font-medium">Ui/Ux Designer</p>
          <div
            class="dark:bg-[#37404F] mx-auto mt-4 mb-5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2 shadow-1 dark:border-strokedark">
            <div
          ...
          <div class="mt-6">
            <h4 class="mb-3 font-medium text-black dark:text-white">
              Follow me on
            </h4>
