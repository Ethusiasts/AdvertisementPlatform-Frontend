...
export default function CreateBillboardForm({ photo, title, description }) {
  ...
  const handleSubmit = (url) => {
    mutation.mutate({
      rate: 2,
      monthly_rate_per_sq: daily_rate_per_square_feet,
      location: location,
      image: url,
      width: width,
      height: height,
    ...
    <form onSubmit={uploadImage}>
      <div class="bg-gray-100 rounded-lg shadow-lg p-16 w-9/10">
        ...
        <p class="text-gray-600 text-base mb-4">
          Fill out the form below and let our experts bring your vision to life.
          Stand out from the crowd and drive real results for your brand. Get
          started now!
        </p>
        <div class="mb-4">
