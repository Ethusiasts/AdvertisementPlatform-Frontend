        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="col-span-1 mb-4 sm:mb-0">
            ...
            <div className="flex items-center py-3 relative">
              <input
                className="text-white appearance-none bg-transparent border-b-2 border-gray-400 w-full mr-3 py-1 px-2 leading-tight focus:outline-none"
                type="text"
