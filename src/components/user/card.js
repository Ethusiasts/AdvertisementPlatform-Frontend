    ...
    <div class="px-4 py-5 sm:p-6">
      <div class="flex items-center">
        <div class="flex-shrink-0 bg-blue-500 rounded-md p-3">
          <svg class="h-6 w-6 text-gray-600 dark:text-gray-400" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM5.7 6.3a1 1 0 011.4 0l2 2a1 1 0 01-1.4 1.4l-1.3-1.3-1.3 1.3a1 1 0 01-1.4-1.4l2-2zM9 11a1 1 0 100 2 1 1 0 000-2z" clip-rule="evenodd" />
          </svg>
        </div>
        <div class="ml-5">
