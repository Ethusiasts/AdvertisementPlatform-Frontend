            ...
            <tbody class="bg-white divide-y dark:divide-gray-300 dark:bg-gray-100">
              <tr class="bg-gray-50 dark:bg-gray-100 hover:bg-gray-100 dark:hover:bg-gray-400 text-gray-700 dark:text-black">
                ...
                <td class="px-4 py-3 text-sm flex justify-center gap-4">
                  <button class="px-2 py-1 text-xs font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-blue-700 dark:text-green-100">
                    {" "}
                    View Profile{" "}
                  </button>
                  <button class="px-2 py-1 text-xs font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                    {" "}
                    Activate{" "}
                  </button>
                  <button class="px-2 py-1 text-xs font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-red-700 dark:text-green-100">
                    {" "}
                    Deactivate{" "}
                  </button>
                </td>
