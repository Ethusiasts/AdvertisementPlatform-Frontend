    ...
    <>
      ...
      <div class="grid md:grid-cols-5 mx-16 mt-16">
        <div class="col-span-3 border-b pb-10">
          <p class="max-w-xl text-xl text-gray-500 ">
      ...
      <div class="grid md:grid-cols-5 gap-4 mx-16 rounded ">
        <div class="col-span-3 bg-white p-2 border-b">
          ...
          <div class="bg-red-100 border border-red-800 grid md:grid-cols-2 gap-6 py-6 px-3 mb-6">
            <div class="flex justify-between border-b pb-2">
              <h1 class="font-bold ">Billboard-ID:</h1>
              <p class="sm:tracking-tight ">13354</p>
            </div>
            <div class="flex justify-between border-b pb-2">
              <h1 class="font-bold">Board Size:</h1>
              <p class="sm:tracking-tight ">800</p>
            </div>
            <div class="flex justify-between border-b">
              <h1 class="font-bold">Price:</h1>
              <p class="sm:tracking-tight ">Per Month 3,50,000/₹ Birr</p>
            </div>
            <div class="flex justify-between border-b">
              <h1 class="font-bold">Width:</h1>
              <p class="sm:tracking-tight ">40</p>
            </div>
            <div class="flex justify-between border-b">
              <h1 class="font-bold">Board Status:</h1>
              <p class="sm:tracking-tight ">Buy Available</p>
            </div>
            <div class="flex justify-between border-b pb-2">
              <h1 class="font-bold">Height:</h1>
              <p class="sm:tracking-tight ">20</p>
            </div>
          </div>
        </div>
        <div class="col-span-2 p-5 mt-5">
          <h2 class="text-2xl font-bold pb-3">Address</h2>
          <p class="text-gray-500 pb-4"> Addis Ababa, Ethiopia</p>
          <iframe
            ...
            <div class="mb-1 tracking-wide px-4">
              <div class="grid grid-cols-4 -mx-8 pb-3">
                <div class="cols-span-1 mt-1 justify-center">
                  <h1 class="text-3xl font-bold">4.9</h1>
                  <div class="flex my-2">
                    <svg
