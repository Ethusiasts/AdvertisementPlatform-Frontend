import CreateTvAdForm from "../../components/advertisement/createTvAd"
import SideBar from "../../components/user/sidebar"
import Header from "../../components/user/header"
import Label from "../../components/advertisement/label"

export default function CreateTvAd({ status, place, city, width, height, location, imageSrc, alt }) {
    return (
...
<div class="flex items-center justify-center p-10"><CreateTvAdForm/></div>
      </div>
</div>
)};
