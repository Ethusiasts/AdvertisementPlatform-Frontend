...
<div class="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-4">
  <div class="p-5"><Card title="Magazine" description="Get Noticed: Create a Stunning Magazine Ad to Showcase Your Brand and Boost Sales" route="/CreateMagazineAd" photo="https://images.unsplash.com/photo-1614036634955-ae5e90f9b9eb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80"/></div>
  <div class="p-5"><Card title="Billboard" description="Take Your Message to New Heights: Design a Memorable Billboard Ad Today" route="/CreateBillboardAd" photo="https://images.unsplash.com/photo-1576864333214-b2cee50f8283?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80"/></div>
  ...
  <div class="p-5"><Card title="TV" description="Tell Your Story on the Big Screen: Design a TV Ad That Leaves a Lasting Impression on Your Viewers!" route="/CreateTvAd" photo="https://images.unsplash.com/photo-1560169897-fc0cdbdfa4d5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2072&q=80"/></div>
</div>
        <Table />
      </div>
</div>
