...
export default function CreateBillboardAd({ status, place, city, width, height, location, imageSrc, alt }) {
    return (
...
<div class="flex items-center justify-center p-10 px-20"><CreateBillboardAdForm/></div>
      </div>
</div>
)};
