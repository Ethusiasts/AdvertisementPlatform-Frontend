...
export default function EditProfilePage({ status, place, city, width, height, location, imageSrc, alt }) {
    return (
...
<div class="flex items-center justify-center pl-14"><EditProfileCard/></div>
      </div>
</div>
)};
