import BillboardTable from "../../components/proposal/billboardTable"
import SideBar from "../../components/billboards/sidebar"
import Header from "../../components/billboards/header"

export default function BillboardProposal({ status, place, city, width, height, location, imageSrc, alt }) {
    return (
